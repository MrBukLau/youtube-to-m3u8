...
python3 believeinfuturetv.py > ../streams/believeinfuturetv.m3u8
...
python3 hopsports.py > ../streams/hopsports.m3u8
...
python3 iqiyianime.py > ../streams/iqiyianime.m3u8
...
python3 iqiyimidnighttheater.py > ../streams/iqiyimidnighttheater.m3u8
...
python3 sandacabletv.py > ../streams/sandacabletv.m3u8
